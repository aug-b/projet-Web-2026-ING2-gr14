...
<style>
        ...
        *{
        ...
        body{
            background:linear-gradient(180deg,#082f72,#0b4bb3);
            min-height:100vh;
            display:flex;
            padding:20px;
        }
...
<?php } ?>
                ...
                <form id="formInscription" action="demande-contact.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                           ...
                           <div class="input-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="telephone" placeholder="Entrer votre téléphone">
                            </div>
...
.addEventListener("blur", function(){
    ...
    .then(data => {
        ...
        const message =
        document.getElementById("messageEmail");
